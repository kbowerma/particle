...
documentHeight = 1600 #this is  guess since we need to make the document before we know the file size, doesn't really matter anyway
...
def writeText(i,value,row):
  ...
  text = dwg.add(dwg.text(str(value), insert=(0,textstart),font_size=12, font_family='Trebuchet MS', fill='black'))
